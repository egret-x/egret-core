...
declare namespace egret {
    ...
    */
    ...
    class MovieClip extends DisplayObject {
         ...
         * MovieClip数据源
         */
        set movieClipData(value: MovieClipData);
        /**
         * @version Egret 2.4
         * @platform Web,Native
         */
        get movieClipData(): MovieClipData;
        /**
         * @private
         *
         * @param value
...
declare namespace egret {
    ...
    class MovieClipData extends HashObject {
         ...
         * MovieClip数据源
         */
        set mcData(value: MovieClipData);
        /**
         * @version Egret 2.4
         * @platform Web,Native
         */
        get mcData(): MovieClipData;
        /**
         * @private
         *
         * @param value
...
declare namespace egret {
    ...
    class MainContext extends EventDispatcher {
         ...
         * @platform Web,Native
         */
        static get instance(): egret.MainContext;
    }
}
declare namespace egret {
    /**
